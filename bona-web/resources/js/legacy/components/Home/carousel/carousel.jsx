...
const CustomCarousel = () => {
  ...
  // 🎯 Solo muestra botón login SI NO está logueado
    ...
    <div id="carouselExample" className="carousel slide carousel-fullscreen" data-bs-ride="carousel">
      ...
      <div className="carousel-caption d-flex justify-content-center">
        <div className="text-center p-5 rounded-5 shadow-xl mx-auto position-relative glass-card" style={{ width: "95%", maxWidth: "1100px", minWidth: "800px" }}>
          ...
          {/* ✅ BOTONES: Solo login SI NO logueado, SIEMPRE reserva */}
          <div className="d-flex gap-4 justify-content-center flex-wrap mx-auto w-100 mb-4">
            {showLoginButton && (
              <button 
                ...
                className="btn btn-outline-company btn-xl flex-fill text-nowrap px-6 py-3 fw-bold fs-4 shadow-lg company-btn min-width-btn"
              >
                {t('carousel.login')}
              </button>
            )}
            
            <a href="/erreserbak" className="btn btn-company btn-xl flex-fill text-nowrap px-6 py-3 fw-bold fs-4 shadow-lg company-btn min-width-btn">
              {t('carousel.reserve')}
            </a>
          </div>
