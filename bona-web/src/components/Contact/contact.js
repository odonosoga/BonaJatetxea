...
const Contact = () => {
  return (
    <section id="kontaktua" className="py-5 contact-section">
      <Container>
        {/* Título */}
        <div className="text-center mb-5">
          <h2 className="display-5 fw-bold text-dark mb-3">Kontaktua</h2>
          <p className="lead text-muted mb-0">Gurekin harremanetan jar zaitez</p>
        </div>
              ...
              <Card.Body className="p-4 p-lg-5">
                ...
                <Form>
                  <Row>
                    <Col md={6} className="mb-3">
                      <Form.Group>
                        ...
                        <Form.Control type="text" placeholder="Zure izena" required />
                      </Form.Group>
                    </Col>
                    <Col md={6} className="mb-3">
                      <Form.Group>
                        <Form.Label className="fw-medium">Emaila</Form.Label>
                        <Form.Control type="email" placeholder="email@adibidea.com" required />
                      </Form.Group>
                    </Col>
                  </Row>
                  ...
                  <Row>
                    ...
                    <Col md={6} className="mb-4">
                      <Form.Group>
                        ...
                        <Form.Select>
                          <option>2 pertsona</option>
                          <option>3 pertsona</option>
                          <option>4 pertsona</option>
                          <option>5+ pertsona</option>
                        </Form.Select>
                      </Form.Group>
                    </Col>
                  </Row>
                  ...
                  <Form.Group className="mb-4">
                    <Form.Label className="fw-medium">Data eta ordua</Form.Label>
